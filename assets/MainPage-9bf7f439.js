import{s as l,j as n,r as T,g as at,c as it,d as st,L as Fe,e as lt,h as ct,i as dt}from"./index-a55f6d7e.js";import{i as z}from"./icons-79d32931.js";import{C as pt,A as ut,D as ft}from"./index-3d9009d7.js";import{u as ht}from"./index.esm-81098c7c.js";import{b as mt}from"./breakfast-image-23aee249.js";const xt=l.h4`
...
`;pt.register(ut);const no=e=>{const t={cutout:"80%",plugins:{legend:{display:!1}},tooltips:{enabled:!1},hover:{mode:null},events:[]},o={labels:["Filled","Empty"],datasets:[{data:[75,25],backgroundColor:[e.color,"#292928"],borderColor:["transparent","#292928"],borderWidth:[0,0],borderRadius:[168,0]}]},i={id:"backgroundCircle",beforeDatasetsDraw(s,h,v){const{ctx:a}=s;a.save();const y=s.getDatasetMeta(0).data[0].x,x=s.getDatasetMeta(0).data[0].y,g=s.getDatasetMeta(0).data[0].innerRadius,u=s.getDatasetMeta(0).data[0].outerRadius,m=u-g,b=Math.PI/180;a.beginPath(),a.lineWidth=m,a.strokeStyle="#292928",a.arc(y,x,u-m/2,0,b*360,!1),a.stroke()}};return n.jsx(to,{$widthpx:e.widthpx,$heightpx:e.heightpx,data:o,options:t,plugins:[i]})},ie=no,oo=l.p`
  color: var(--primary-title-text-color);
  text-align: center;
  font-size: 32px;
  font-style: normal;
...
`,ro=l.div`
  ...
  display: flex;
  align-items: center;
`,ao=({calories:e})=>n.jsxs(ro,{children:[n.jsx(ie,{color:"#45FFBC",widthpx:168,heightpx:168}),n.jsxs(oo,{children:["1360 ",n.jsx("span",{children:"calories"})]})]}),io=ao;function so({stats:e}){return n.jsxs(Jn,{children:[n.jsx(Xn,{children:"Food"}),n.jsxs(Zn,{children:[n.jsx(io,{}),n.jsxs(eo,{children:[n.jsxs(he,{children:[n.jsx(ie,{heightpx:48,widthpx:48,color:"#FFC4F7"}),n.jsx(me,{children:"80%"}),n.jsxs(xe,{children:[n.jsx("h3",{children:"Carbohidrates"}),n.jsxs("div",{children:[n.jsxs("p",{children:["Goal: ",n.jsx("span",{children:"170"})]}),n.jsxs("p",{children:["left: ",n.jsx("span",{children:"34"})]})]})]})]}),n.jsxs(he,{children:[n.jsx(ie,{heightpx:48,widthpx:48,color:"#FFF3B7"}),n.jsx(me,{children:"80%"}),n.jsxs(xe,{children:[n.jsx("h3",{children:"Protein"}),n.jsxs("div",{children:[n.jsxs("p",{children:["Goal: ",n.jsx("span",{children:"127.5"})]}),n.jsxs("p",{children:["left: ",n.jsx("span",{children:"8"})]})]})]})]}),n.jsxs(he,{children:[n.jsx(ie,{heightpx:48,widthpx:48,color:"#B6B6B6"}),n.jsx(me,{children:"80%"}),n.jsxs(xe,{children:[n.jsx("h3",{children:"Fat"}),n.jsxs("div",{children:[n.jsxs("p",{children:["Goal: ",n.jsx("span",{children:"56"})]}),n.jsxs("p",{children:["left: ",n.jsx("span",{children:"11,2"})]})]})]})]})]})]})]})}const lo=l.div`
  display: flex;
  flex-direction: column;
  gap: 20px;
  margin-bottom: 20px;
...
`;dt.defaults.baseURL="https://healthy-hub-rest-api.onrender.com/api";function uo(){const[e,t]=T.useState({}),o=lt(ct);return T.useEffect(()=>{t(o.user)},[o]),n.jsxs("div",{children:[n.jsxs(co,{children:[n.jsx("h2",{children:"Today"}),n.jsxs(po,{to:"/dashboard",children:["On the way to the goal",n.jsx("svg",{children:n.jsx("use",{href:`${z}#icon-arrow-right`})})]})]}),n.jsxs(lo,{children:[n.jsx(yt,{calories:e.dailyCalories,water:e.dailyWater}),n.jsx(Yn,{waterobjective:e.dailyWater,watercurrent:e.consumedWaterByDay}),n.jsx(so,{stats:e.consumedMealsByDay})]})]})}const fo=l.li`
...
`,zo=l.ul`
  ...
  row-gap: 28px;
  width: 100%;
`,$o=()=>n.jsxs(Lo,{children:[n.jsxs(Io,{children:[n.jsx(Uo,{children:"Diary"}),n.jsx(Bo,{to:"/diary",children:"See more"})]}),n.jsxs(zo,{children:[n.jsx(ae,{title:"Breakfast",image:mt}),n.jsx(ae,{title:"Lunch",image:Fo}),n.jsx(ae,{title:"Dinner",image:ko}),n.jsx(ae,{title:"Snack",image:Wo})]})]}),Ho=$o,qo=l.section`
  /* width: 320px; */
  /* margin: 0 auto; */
  display: flex;
  flex-direction: column;
...
`,Ko=qo;function Go(){const e=[1,2,3,4],t={carbohydrates:14,protein:.3,fat:.2,name:"Apples",amount:"100 g",img:"https://ftp.goit.study/img/you_health/Apples.png",calories:52},{name:o,amount:i,img:s,calories:h}=t;return n.jsxs(Ko,{children:[n.jsx("h2",{children:"Recommended Food"}),n.jsxs("div",{className:"wrapper",children:[n.jsx("ul",{children:e.map(v=>n.jsx("li",{children:n.jsxs("div",{className:"description",children:[n.jsx("div",{className:"small_img_div",children:n.jsx("img",{src:s,alt:"",width:46,height:46})}),n.jsxs("section",{children:[n.jsx("h4",{children:o}),n.jsxs("p",{children:[i,n.jsxs("span",{children:[h," calories"]})]})]})]})},v))}),n.jsxs("a",{className:"href",href:"././Recommended-food",children:["See more",n.jsx("svg",{className:"svg",children:n.jsx("use",{href:`${z}#icon-arrow-right`})})]})]})]})}const Vo=l.div`
  display: flex;
  flex-wrap: wrap;
  gap: 20px;
...
`;function er(){return n.jsxs(n.Fragment,{children:[n.jsx("p",{children:"MainPage"}),n.jsx(uo,{}),n.jsxs(Vo,{children:[n.jsx(Ho,{}),n.jsx(Go,{})]})]})}export{er as default};
